...
prog:
	| cls = list(class_decl); e = expr; EOF { AProg(cls,e) }
	;
...
expr:
   ...
   | LETREC; x = ID; LPAREN; y = ID; RPAREN; EQUALS; e1 = expr; IN;
    ...
    | LIST; LPAREN; es= separated_list(COMMA, expr);
      RPAREN { List(es)}
          | HD; LPAREN; e = expr; RPAREN { Hd(e) }
    | TL; LPAREN; e = expr; RPAREN { Tl(e) }
    | EMPTYPRED; LPAREN; e = expr; RPAREN { EmptyPred(e) }
...
class_decl:
 ...
 mths = list(method_decl); RBRACE { Class(id1,id2,ofs,mths)}
         ;
...
method_decl: METHOD; id=ID; LPAREN;
           params = separated_list(COMMA, ID); RPAREN; LBRACE;
           e=expr; RBRACE { Method(id,params,e) }
           ;
