...
/*
 * Linked list management definitions
 * Is a double-linked list for convenience
 */

typedef struct ti_node {
    pid_t pid;
    pid_t tgid;
    struct ti_node * next;
    struct ti_node * prev;
...
#define SCULL_IOCIQUANTUM _IOR(SCULL_IOC_MAGIC,  7, task_info)
